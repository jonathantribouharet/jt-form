...
$(document).one('jt-register-components', function(){
	...
	function create(context){
		context.inputs = {
			...
			value: context.view.find('input').last()
		};
	}
	...
	function validate(context){
		...
		if(!JT.validateNotBlank(context.data.name) && !JT.validateNotBlank(context.data.value)){
			result = null;
		}
		else if(JT.validateNotBlank(context.data.name) && JT.validateNumeric(context.data.value)){
			result = true;
		}
