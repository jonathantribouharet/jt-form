...
$(document).one('jt-register-components', function(){
	...
	function validate(context){
		...
		if(!JT.validateNotBlank(context.data.name) && !JT.validateNotBlank(context.data.url)){
			result = null;
		}
		else if(JT.validateNotBlank(context.data.name) && JT.validateNotBlank(context.data.url)){
			result = true;
		}
